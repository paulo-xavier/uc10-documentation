...
<br>
 ...
 ## Table of contents
- [Explananation about the code](#explanation-about-the-code)
...
In the first line we improt a package called <code>pandas</code>. This package will allow us to read the `.csv` file and generate a new file based on that. 
